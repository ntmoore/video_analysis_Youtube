...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{Etkina-Y-T-plot.pdf}
%\includegraphics[width=\columnwidth]{Etkina-Y-T-plot.jpg}
\caption{
%A plot from LoggerPro showing the vertical position of the clock (red), the ball (blue), and the difference between the two (purple), the vertical position of the ball relative to the clock. Looking carefully, you can see that correcting for the relative motion of the camera eliminates the asymmetry in the (blue) direct measurement of altitude.  
...
Looking carefully, you can see that correcting for the relative motion of the camera eliminates the asymmetry in the direct measurement of altitude.  
}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{Etkina-X-T-plot.pdf}
...
\includegraphics[width=\columnwidth]{bear-speed.pdf}
\caption{
%A screenshot from LoggerPro, 
...
%\includegraphics[width=\columnwidth]{bear-quadratic.png}
\includegraphics[width=\columnwidth]{bear-quadratic.pdf}
\caption{
...
E. Etkina,
\textit{Millikan award lecture: Students of physics—Listeners, observers, or collaborative participants in physics scientific practices? }
Am. J. Phys.
\textbf{83(8)}, 669
%669-679
(2015). 
...
and 
D. T. Brookes and E. Etkina 
\textit{Physical Phenomena in real time},
Science 
\textbf{330}, 605
%605-606
(2010). 
...
E. Rosén and U. Sander,
\textit{Pedestrian fatality risk as a function of car impact speed},
